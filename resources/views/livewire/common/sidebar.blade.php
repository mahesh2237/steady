<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          @livewire('common.sidebar-link', ['link' => 'user-profile','label'=> 'Profile'])
          
          
        </li>
        <li class="nav-item pb-2">
          
          @livewire('common.sidebar-link', ['link' => 'customer-management','label'=> 'Customer Management'])
        ...
        <li class="nav-item">
          @livewire('common.sidebar-link', ['link' => 'tables','label'=> 'Tables'])
        </li>
        <li class="nav-item">
          @livewire('common.sidebar-link', ['link' => 'billing','label'=> 'Billing'])
        </li>
        <li class="nav-item">
          @livewire('common.sidebar-link', ['link' => 'virtual-reality','label'=> 'Virtual Reality'])
        
            
        </li>
        <li class="nav-item">
          @livewire('common.sidebar-link', ['link' => 'rtl','label'=> 'RTL'])
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Account pages</h6>
        </li>
        <li class="nav-item">
          @livewire('common.sidebar-link', ['link' => 'profile','label'=> 'Profile'])
        </li>
        <li class="nav-item">
